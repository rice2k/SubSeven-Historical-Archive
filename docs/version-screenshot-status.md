# SubSeven Version Screenshot Coverage

This page maps each major SubSeven release/branch to the visual evidence currently available in the archive.
...
Machine-readable image map: [`../data/screenshot-index.csv`](../data/screenshot-index.csv)  
Version history: [`version-and-file-history.md`](version-and-file-history.md)
...
# Repository-hosted visual evidence relevant to version research

| Hosted file | Relevance |
|---|---|
| [`classic-subseven-interface.jpg`](../assets/images/classic-subseven-interface.jpg) | representative classic-family controller; exact release not yet proven |
| [`subseven-art-gallery.png`](../assets/images/subseven-art-gallery.png) | historical artwork/icon reference |
| [`illwill-sub7-source-provenance.jpg`](../assets/images/illwill-sub7-source-provenance.jpg) | source-provenance evidence for the 2.1.2/2.1.3-era source discussion |
| [`wayback-sub7-reference.jpg`](../assets/images/wayback-sub7-reference.jpg) | general website/archive research reference |
| [`wayback-sub7-org-2001-retry.jpg`](../assets/images/wayback-sub7-org-2001-retry.jpg) | archive-retry evidence, not original website design |
| [`wayback-sub7crew-org-2001-retry.jpg`](../assets/images/wayback-sub7crew-org-2001-retry.jpg) | archive-retry evidence, not original website design |
| [`wayback-otenet-sub7-files-2002-retry.jpg`](../assets/images/wayback-otenet-sub7-files-2002-retry.jpg) | archive-retry evidence, not original website design |
